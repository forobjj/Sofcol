...
function GestionUsuarios() {
    ...
    const initialState = { _id: '', nombre: '', apellido: '', documento: '', correo: '', Estado: '', Rol: '' }
        ...
        <main className="guiGestionUsuarios">
            ...
            <Formulario action="" onSubmit={onSubmitForm}>
                ...
                <Input
                    ...
                    DefVal={usuarios.correo}
                    tipo="text"
                    user="correo"
                    placeholdercont="Correo"
                    name="correo"
                    leyenda="Ingresae un correo valido"
                ...
                <Selects
                    ...
                    user="Rol"
                    name="Rol"
                    leyenda="Administrador/ Lider / Estudiante"
                    expresionRegular={Expresiones.nombre}
                    opciones={opcion1}
                    usuarios={usuarios}
                    setUsuarios={setUsuarios}
